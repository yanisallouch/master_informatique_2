	  ...
	  public static void main(String[] args)
	    {
		  ...
		  "SELECT ?s ?couleur WHERE { ?s animal:couleur ?couleur . "
		  + " OPTIONAL {?s animal:age ?age .} " 
		 +  " FILTER (!bound(?age)) }" ;
		  ...
		  try {
			  ...
			  System.out.println("les personnages qui ont une couleur mais pas d'age");
			  for (;results.hasNext();)
			  {
				  QuerySolution sol = results.next();
				  RDFNode s = sol.get("s");
				  RDFNode a = sol.get("couleur");
