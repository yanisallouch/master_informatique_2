 ...
 * @generated
 */
public class MaquetteSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MaquettePackage.FORMATION: {
				Formation formation = (Formation)theEObject;
				T result = caseFormation(formation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaquettePackage.SEMESTRE: {
				Semestre semestre = (Semestre)theEObject;
				T result = caseSemestre(semestre);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaquettePackage.UE: {
				UE ue = (UE)theEObject;
				T result = caseUE(ue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaquettePackage.COMPÉTENCE: {
				Compétence compétence = (Compétence)theEObject;
				T result = caseCompétence(compétence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaquettePackage.FORMATIONS: {
				Formations formations = (Formations)theEObject;
				T result = caseFormations(formations);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Compétence</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Compétence</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCompétence(Compétence object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Formations</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Formations</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFormations(Formations object) {
		return null;
	}
